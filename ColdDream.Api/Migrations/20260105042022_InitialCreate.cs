        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TourRouteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ButlerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Butlers_ButlerId",
                        column: x => x.ButlerId,
                        principalTable: "Butlers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_TourRoutes_TourRouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ButlerId",
                table: "Bookings",
                column: "ButlerId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TourRouteId",
                table: "Bookings",
                column: "TourRouteId");
